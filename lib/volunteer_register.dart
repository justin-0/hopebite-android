...
//                           _box(usernameController, "Username"),
//                           _box(passwordController, "Password", hide: true),
//                           _box(emailController, "Email"),
//                           _box(phoneController, "Phone", number: true),
...
//                           ),
//                         ),
//                         onPressed: loading ? null : registerVolunteer,
//                         child: loading
...
//       Fluttertoast.showToast(msg: "Phone must be 10 digits");
//       return;
//     }
//
...
//       "POST",
//       Uri.parse("$url/volunteer_register/"),
//     );
//
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _box(nameController, "Name", errorText: nameError),
                          _box(usernameController, "Username", errorText: usernameError),
                          _box(passwordController, "Password", hide: true, errorText: passwordError),
                          _box(emailController, "Email", errorText: emailError),
                          _box(phoneController, "Phone", number: true, errorText: phoneError),
                          _box(placeController, "Place", errorText: placeError),
                          _box(addressController, "Address", errorText: addressError),
                        ],
                      ),
                    ),
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: errorText != null
                  ...
                  bottomRight: Radius.zero,
                    ...
                    : BorderRadius.circular(12),
                borderSide: BorderSide(
                  color: errorText != null ? Colors.red : const Color(0xFF00796B),
                ),
              ),
            ),
          ),
